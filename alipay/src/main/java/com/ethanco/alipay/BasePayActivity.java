...
import com.ethanco.alipay.utils.SignUtils;
...
public abstract class BasePayActivity extends AppCompatActivity {
    ...
    // 商户收款账号
    public static final String SELLER = AliPayConfig.SELLER;
    // 商户私钥，pkcs8格式
     ...
     * @param payResult
     */
    protected abstract void payFailed(PayResult payResult);
     ...
     * @param payResult
     */
    protected abstract void payUnknown(PayResult payResult);
     ...
     * @param payResult
     */
    protected abstract void paySuccess(PayResult payResult);
